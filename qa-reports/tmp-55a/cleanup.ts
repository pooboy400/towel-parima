/**
 * پاکسازی کامل دیتای تستی 55-a (فقط ردیف‌های ساخته‌شده توسط این ایجنت)
 * اجرا: cd /home/z/my-project/towel-parima && DATABASE_URL="$(bash scripts/pg.sh url)" bun qa-reports/tmp-55a/cleanup.ts
 */
import { PrismaClient } from "@prisma/client";
const db = new PrismaClient();

const ORDER_CODE = "1073076560";
const ORDER_PHONE = "09135501234"; // گارد ضدخطا: سفارش دیگری پاک نشود
const AUDIT_EMAIL = "locktest-a@example.invalid";
const MINTED_EMAILS = [
  "sec01-55a+super_admin@prima.test",
  "sec01-55a+support_agent@prima.test",
  "sec01-55a+store_manager@prima.test",
];
...
// ۶) ردیف‌های audit تستی SEC-03 (۱۱ ردیف ایمیل آزمایشی)
